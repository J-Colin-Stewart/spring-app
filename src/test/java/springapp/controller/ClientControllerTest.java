...
public class ClientControllerTest {
    ...
    static  {
        clients.add(new Client(1, "John Doe", "555-555-5555", "1234 main street", "JohnDoe@theinternet.com"));
        clients.add(new Client(2, "Jane Smith", "555-123-1234", "9876 country road", "JaneSmith@theinteret.com"));
